...
- Update the activation function to instantiate `ExtensionRuntime` and handle initialization.
- Remove redundant workspace folder selection logic and associated error handling.
